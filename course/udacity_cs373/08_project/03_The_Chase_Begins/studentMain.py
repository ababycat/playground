...
# TODO: 返回你想要机器人转动的角度，距离和其他变量(任何你想要跟踪的变量)
# 
# ----------
# GRADING
# 
...
# Please note that there is measurement noise in this problem.
# Plan how you want the hunter to approach the target. 
# Instead of going straight for the current target position or next one, 
# see if it is more "feasible" to catch it after some more time steps. 
# This will become especially important when we are able to vary the speed of the hunter.
...
# measurement_noise = target.distance
target.set_noise(0.0, 0.0, measurement_noise)

hunter = robot(-10.0, -10.0, 0.0)

# print demo_grading(hunter, target, naive_next_move)
# demo_grading_show(hunter, target, naive_next_move)
print demo_grading(hunter, target, next_move)
# demo_grading_show(hunter, target, next_move)
